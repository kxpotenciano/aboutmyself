...
export default function Hobbies(){
  ...
  <button
    ...
    <a href="http://localhost:3000/Music">Music</a>
            ...
            <div className="container inline-block block rounded-lg bg-white text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-gray-700 vh-100 w-96">
